...
import { callsByHour } from "@/lib/data";
    ...
    <div className="card p-5">
      <div className="flex items-center justify-between mb-4">
        <div>
          ...
          <div className="text-xl font-semibold tracking-tight text-white">14 calls</div>
        </div>
        <div className="pill-emerald">+12% vs yesterday</div>
      </div>
      <div className="h-56">
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={callsByHour} margin={{ top: 5, right: 10, left: -10, bottom: 0 }}>
            <defs>
