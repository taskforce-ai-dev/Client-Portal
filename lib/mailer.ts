...
export async function sendAdminInviteEmail(input: {
  ...
  const subject = "You've been invited to Sentinel Admin";

  const text = `Hi ${name},

You've been invited as an admin on Sentinel.
...
You can change your password after signing in.`;
  ...
  const html = `
    <div style="font-family:-apple-system,Segoe UI,Roboto,sans-serif;max-width:480px;margin:0 auto">
      <h2 style="margin-bottom:4px">You've been invited to Sentinel</h2>
      <p style="color:#444">Hi ${escapeHtml(name)}, an account was created for you on the Sentinel admin console.</p>
      ...
      <p><a href="${loginUrl}" style="display:inline-block;background:#e11d3c;color:#fff;padding:10px 20px;border-radius:6px;text-decoration:none">Sign in to Sentinel</a></p>
